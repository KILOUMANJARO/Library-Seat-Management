...
Q_CONSTINIT const QMetaObject reg::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSregENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onCreditTextChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_upidTextChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void reg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->onCreditTextChanged(); break;
        case 7: _t->on_upidTextChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 8: _t->clearTextFields(); break;
        default: ;
        }
        ...
        {
            using _t = void (reg::*)();
            if (_t _q_method = &reg::mysignal2; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
